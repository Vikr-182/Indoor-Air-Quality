...
response = requests.get("https://api.thingspeak.com/channels/911122/fields/2?api_key=HKJF50PJ4NF1ZGC2")
...
ax1.set_title('PM10 Concentration')
ax1.set(xlabel='Time',ylabel='PM10 in ppm')
