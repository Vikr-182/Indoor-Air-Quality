...
response = requests.get("https://api.thingspeak.com/channels/911120/fields/3?api_key=HKJF50PJ4NF1ZGC2")
...
ax1.set_title('NH3 Concentration')
ax1.set(xlabel='Time',ylabel='NH3 in ppm')
