...
response = requests.get("https://api.thingspeak.com/channels/911120/fields/2?api_key=HKJF50PJ4NF1ZGC2")
...
ax1.set_title('NO2 Concentration')
ax1.set(xlabel='Time',ylabel='NO2 in ppm')
